      ...
      <div className="container-custom section-padding">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Your ERP</span>
            </div>
            <p className="text-neutral-400 mb-6 leading-relaxed">
              Manufacturing intelligence designed for your business. Personalizable,
              compliant, and built for scale.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#compliance" className="text-neutral-400 hover:text-white transition-colors">Compliance</a></li>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © 2026 Your ERP. All rights reserved.
          </p>
