...
- **Material Nesting** — compare sheet quantities and optional material costs from DXFs or simple shapes at `/nest`, inside the authenticated ERP. Estimates use inches and save to local files. See [docs/MATERIAL_NESTING.md](docs/MATERIAL_NESTING.md).
