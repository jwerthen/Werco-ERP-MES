...
DEFAULT_INSTRUCTIONS = (
    ...
    "separate, explicit step that puts work on the floor.\n"
    "- import_laser_nest_package: the API creates the laser work order RELEASED; the tool sets it back to DRAFT "
    "unless release=true, and refuses a target that already carries manually entered nests.\n"
