...
def list_report_templates(
    ...
    templates = (
        ...
        .filter(
            ...
            (ReportTemplate.created_by == current_user.id) | (ReportTemplate.is_shared == True),
        )
...
def get_available_data_sources(current_user: User = Depends(require_role([UserRole.ADMIN, UserRole.MANAGER]))):
