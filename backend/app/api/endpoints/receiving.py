...
from app.services.receiving_commands import (
    _add_to_inventory,
    _receive_material,
)
from app.services.receiving_commands import generate_receipt_number as _generate_receipt_number

router = APIRouter()


def generate_receipt_number(db: Session, company_id: int) -> str:
    return _generate_receipt_number(db, company_id)
