...
def calculate_cnc_quote(
    ...
    material = (
        ...
        .filter(QuoteMaterial.id == request.material_id, QuoteMaterial.company_id == company_id)
        .first()
    )
    if not material:
    ...
    machine = (
        ...
        .filter(
            QuoteMachine.machine_type.in_(
                [MachineType.CNC_MILL_3AXIS, MachineType.CNC_MILL_4AXIS, MachineType.CNC_MILL_5AXIS]
            ),
    ...
    complexity_factors = {"simple": 0.7, "medium": 1.0, "complex": 1.5, "very_complex": 2.5}
    ...
    # Tolerance surcharge
    tolerance_surcharges = get_setting(
        db, "tolerance_surcharges", {"standard": 1.0, "tight": 1.15, "precision": 1.35, "ultra": 1.6}
    )
...
def calculate_sheet_metal_quote(
    ...
    hardware_material = request.num_pem_inserts * pem_cost_each + request.num_weld_nuts * weld_nut_cost_each
...
@router.get("/machines")
def list_machines(
    machine_type: Optional[str] = None, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)
):
...
@router.get("/finishes")
def list_finishes(db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def update_setting(
    ...
    if setting:
        ...
        setting = QuoteSettings(setting_key=key, setting_value=value, setting_type=setting_type)
        db.add(setting)
    db.commit()
...
def seed_default_data(db: Session = Depends(get_db), current_user: User = Depends(require_role([UserRole.ADMIN]))):
    ...
    default_materials = [
        (
            ...
            0.098,
            1.5,
            {"10ga": 4.50, "12ga": 3.75, "14ga": 3.25, "16ga": 2.75, "18ga": 2.25},
        ),
        (
            "304 Stainless Steel",
            "stainless",
            ...
            0.289,
            0.6,
            {"10ga": 8.50, "12ga": 7.00, "14ga": 6.00, "16ga": 5.00, "18ga": 4.00},
        ),
        (
            ...
            0.283,
            1.0,
            {"10ga": 3.50, "12ga": 2.75, "14ga": 2.25, "16ga": 1.85, "18ga": 1.50},
        ),
        (
            ...
            0.283,
            1.0,
            {"10ga": 3.00, "12ga": 2.50, "14ga": 2.00, "16ga": 1.65, "18ga": 1.35},
        ),
        (
            "5052-H32 Aluminum",
            "aluminum",
            ...
            0.097,
            1.4,
            {"10ga": 4.25, "12ga": 3.50, "14ga": 3.00, "16ga": 2.50, "18ga": 2.00},
        ),
    ...
    default_machines = [
        ...
        (
            ...
            0.25,
            {
                ...
                "aluminum": {"10ga": 200, "12ga": 300, "14ga": 400, "16ga": 500, "18ga": 600},
            },
            None,
        ),
