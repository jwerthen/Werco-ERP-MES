...
class MRPRequirement(Base, TenantMixin):
    ...
    # 003; skipped by the create_all+stamp bootstrap): the per-run requirements
    # load (MRPRun.requirements relationship IN-probe on mrp_run_id -- otherwise
    # unindexed) at the natural (run, part) grain.
    __table_args__ = (Index("ix_mrp_requirements_run_part", "mrp_run_id", "part_id"),)
...
class MRPAction(Base, TenantMixin):
