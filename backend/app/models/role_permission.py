...
class RolePermission(Base, TenantMixin):
    ...
    __table_args__ = (UniqueConstraint('company_id', 'role', name='uq_role_permissions_company_role'),)
...
PERMISSION_CATEGORIES = {
    ...
    'Admin': ['admin:settings', 'admin:integrations', 'admin:audit_logs', 'admin:system'],
}
