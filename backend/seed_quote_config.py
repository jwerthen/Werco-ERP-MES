...
def seed_settings():
    ...
    settings_data = [
        ...
        {'setting_key': 'rfq_scrap_factor', 'setting_value': '0.10', 'setting_type': 'number', 'description': 'Base sheet metal scrap factor'},
        {'setting_key': 'rfq_laser_pierce_seconds', 'setting_value': '0.8', 'setting_type': 'number', 'description': 'Seconds per pierce for laser quoting'},
        {'setting_key': 'rfq_laser_min_charge', 'setting_value': '35', 'setting_type': 'number', 'description': 'Minimum laser operation charge'},
        {'setting_key': 'rfq_brake_min_charge', 'setting_value': '25', 'setting_type': 'number', 'description': 'Minimum press brake operation charge'},
        {'setting_key': 'rfq_finish_min_charge', 'setting_value': '0', 'setting_type': 'number', 'description': 'Default finish minimum charge when no finish match exists'},
