...
![Werco ERP-MES sign-in screen with Badge ID and Email options](images/login.png)
...
![Dashboard showing alerts, KPI cards, and the capacity overview](images/dashboard.png)
...
![Global search box open over the application](images/global-search.png)
...
![Keyboard Shortcuts window listing available shortcuts](images/keyboard-shortcuts.png)
