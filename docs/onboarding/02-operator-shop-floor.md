...
![Check Out window with good-parts, scrap, and notes fields](images/operation-complete-modal.png)
...
![Operation Details window with work instructions and the operation sequence](images/operation-details.png)
