...
**Date:** 2026-07-09 · **Status:** APPROVED — Phase 1 (Flow & Quality Metrics pack) selected to build first; both CI-culture modules (idea board + recurring audits) confirmed in scope as later phases (jwerthen, 2026-07-09)
